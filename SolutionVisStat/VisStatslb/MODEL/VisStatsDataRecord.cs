...
namespace VisStatsBL.MODEL
{
    public class VisStatsDataRecord
    {
        ...
        public int Maand
        {
            ...
            {
                if ((value < 1) || (value > 12))
                    throw new DomeinException("maand is niet correct");
                _maand = value;
            }
        ...
        public double Gewicht
        {
            ...
            {
                if (value < 0)
                    throw new DomeinException("gewicht is niet correct");
                _gewicht = value;
            }
        ...
        public double Waarde
        {
            ...
            {
                if (value < 0)
                    throw new DomeinException("waarde is niet correct");
                _waarde = value;
            }

        }
        private Haven _haven;
        public Haven Haven { get { return _haven;} 
        set { if (value == null) throw new DomeinException("haven is null");
                _haven = value;
            }
        }
        ...
        public Vissoort Vissoort
        {
            ...
            set
            {
                if (value == null) throw new DomeinException("vissoort is null");
                _vissoort = value;
            }
        }
